    ...
    <div class="box-body">
        <div class="feed-new-editor m-10 row">
            <div class="feed-new-avatar">
                <img src="
                <?=$base;?>/media/avatars/<?=$userInfo->avatar;?>" />
            </div>
            ...
            <div class="feed-new-photo">
                ...
                <input type="file" name="photo" class="feed-new-file" accept="image/jpg, image/jpeg, image/jpg" />
            </div>
...
<script>
    ...
    // Enviando informações através do evento de clique
